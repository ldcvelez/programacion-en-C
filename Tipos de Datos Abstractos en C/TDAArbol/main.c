...
int main()
{
    ...
    printf("\n la cantidad de nodos es hasta el nivel dado inclusive es %d",cant_nodos);
    cant_nodos=contar_hasta_nivel_no_inclusive(&pa,2);
    printf("\n la cantidad de nodos es hasta llegar al nivel dado es %d",cant_nodos);
    ...
    printf("\n la cantidad de noos con hijos solo por derecha es %d",cant_nodos);
    return 0;
}
